<template>
  <form @submit.prevent="submitData">
    <div class="form-control" :class="{invalid: userNameInvalid === 'invalid'}">
      <label for="user-name">Your Name</label>
      <input id="user-name" name="user-name" type="text" v-model.trim="userName" @blur="ValidateInput"/>
      <p v-if="userNameInvalid === 'invalid'">Something are wrong</p>
    </div>
    ...
    <div class="form-control">
        ...
        <label for="confirm-terms">Agree to terms of you?</label>
    </div>
    <div class="form-control">
...
export default{
    ...
    methods: {
        ...
        ValidateInput() {
          if(this.userName === '') {
            this.userNameInvalid = 'invalid';
          }
          else {
            this.userNameInvalid = 'not invalid';
          }
        }
     },
}
